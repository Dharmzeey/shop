...
export default function ProductSearchCategory({
    ...
    return (
        <section className="pb-4">
            ...
            {/* Product Grid — Matched to ProductCategory */}
                            ...
                            >
                                ...
                                <div className="relative aspect-square bg-gray-50 overflow-hidden">
                                    ...
                                    <div className="absolute top-3 left-3 flex flex-col gap-2">
                                        <span
                                            className={`status-badge ${product.utilizationStatus === "Brand New"
                                                    ? "status-new"
                                                    : "status-used"
                                                }`}
                                        >
                                        ...
                                        <span
                                            className={`status-badge ${product.availabilityStatus === "In Stock"
                                                    ? "status-in-stock"
                                                    : "status-out-of-stock"
                                                }`}
                                        >
                                    ...
                                    <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-all duration-200 transform translate-y-1 group-hover:translate-y-0">
                                        <div className="flex flex-col gap-1">
                                            <Wishlist
                                                ...
                                                userWishlist={product.user_wishlist}
                                            />
                                            <button
                                                className="w-8 h-8 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center text-gray-700 hover:text-main-color hover:bg-white transition-all duration-200 shadow-lg"
                                                onClick={async (e) => {
                                                    e.preventDefault();
                            ...
                            <div className="p-3 flex-1 flex flex-col">
                                ...
                                <div className="mt-auto">
                                    ...
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.98 }}
                                        onClick={async () => await add(product.id)}
